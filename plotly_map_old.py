...
regions = json.load(open("Inputs\International_Territorial_Level_1_(May_2021)_UK_BUC.geojson", 'r'))
gdp = pd.read_excel('Inputs\February_Regional_Growth.xlsx', sheet_name='Real')
rsme = pd.read_csv("Inputs\\rsme_fake.csv")
rsme = rsme.rename(columns={'Unnamed: 0': 'Region'})
...
itl2 = json.load(open("Inputs\International_Territorial_Level_2_(May_2021)_UK_BUC.geojson", 'r'))
gdp2 = pd.read_csv("Inputs\itl2_faked.csv")
...
itl3 = pd.read_csv("Inputs\itl3_faked_data.csv")
itl3_json = json.load(open("Inputs\International_Territorial_Level_3_(May_2021)_UK_BUC.geojson", 'r'))
itl3_csv = pd.read_csv("Inputs\itl3_faked_data.csv")
itl3_list = itl3_csv.columns.to_list()[1:]
...
app.layout = html.Div([
    ...
    html.Img(src='assets\ons_logo.png', style={'height':'20%', 'width':'20%', 'display':'inline'}),
    ...
    dcc.Graph(
        figure = px.line_polar(rsme, r='Region', theta='Region', line_close=True),
        style={'width': '49%', 'display': 'inline-block'}),
